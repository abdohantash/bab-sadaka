...
! function (y, M, L, a) {
    y.fn.flipBook = function (e) {
        ...
        deeplinkingPrefix: "",
        assets: {
            preloader: "assets/js/flip-book/images/preloader.jpg",
            overlay: "assets/js/flip-book/images/overlay.png",
            flipMp3: "assets/js/flip-book/mp3/turnPage.mp3",
            spinner: "assets/js/flip-book/images/spinner.gif"
        },
        pdfUrl: null,
        ...
        strings: {
            print: "طباعة",
            printLeftPage: "طباعة الصفحة علي اليسار",
            printRightPage: "طباعة الصفحة علي اليمين",
            printCurrentPage: "طباعة الصفحة الحالية",
            printAllPages: "طباعة كل الصفحات",
            download: "تحميل",
            downloadLeftPage: "تحميل الصفحة علي اليسار",
            downloadRightPage: "تحميل الصفحة علي اليمين",
            downloadCurrentPage: "تحميل الصفحة الحالية",
            downloadAllPages: "تحميل كل الصفحات",
            bookmarks: "المحفوظات",
            bookmarkLeftPage: "حفظ الصفحة علي اليسار",
            bookmarkRightPage: "حفظ الصفحة علي اليسار",
            bookmarkCurrentPage: "حفظ كل الصفحات",
            search: "بحث",
            findInDocument: "بحث في الملف",
            pagesFoundContaining: "العثور على صفحات تحتوي على",
            thumbnails: "المصغرات",
            tableOfContent: "الفهرس",
            share: "مشاركة",
